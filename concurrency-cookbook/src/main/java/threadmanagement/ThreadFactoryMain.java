 ...
 *
 * <ul> <li>It's easy to change the class of the objects created or the way we create these
 * objects.</li> <li>It's easy to limit the creation of objects for limited resources. For example,
 * we can only have <i>n</i> objects of a type.</li><li>It's easy to generate statistical data about
 * the creation of the objects.</li> </ul>
 *
